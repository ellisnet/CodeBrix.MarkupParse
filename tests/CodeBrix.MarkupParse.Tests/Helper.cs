...
class Helper
{
    ...
    public static bool IsNetworkAvailable()
    {
        ...
        Assert.Skip("No network has been detected. Test skipped.");
        return false;
    }
    ...
    public static bool IsFramework(params string[] frameworks)
    {
        ...
        Assert.Skip($"The framework {currentFramework} is not compatible with this test.");
        return false;
    }
