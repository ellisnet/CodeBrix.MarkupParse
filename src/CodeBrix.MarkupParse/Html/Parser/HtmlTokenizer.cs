...
/// </summary>
public delegate bool ShouldEmitAttribute(ref StructHtmlToken token, AttributeName attributeName);
...
public sealed class HtmlTokenizer : BaseTokenizer
{
    ...
    private ShouldEmitAttribute _shouldEmitAttribute = static bool (ref StructHtmlToken _, AttributeName _) => true;
    ...
    /// </summary>
    public bool IsPreservingAttributeNames
    {
        get;
        set;
    }
    ...
    /// </summary>
    public bool IsNotConsumingCharacterReferences
    {
        get;
        set;
    }
    ...
    /// </summary>
    public bool IsSupportingProcessingInstructions
    {
        get;
        set;
    }
    ...
    private void AppendCharacterReference(char c, char allowedCharacter = Symbols.Null, bool isAttribute = false)
    {
