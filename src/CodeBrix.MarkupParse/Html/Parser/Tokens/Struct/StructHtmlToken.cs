...
namespace CodeBrix.MarkupParse.Html.Parser.Tokens.Struct;
...
public struct StructHtmlToken
{
    ...
    /// Is this a tag token
    /// </summary>
    public bool IsTag => _type is HtmlTokenType.StartTag or HtmlTokenType.EndTag;
    ...
    /// </summary>
    public bool IsHtmlCompatible => _type == HtmlTokenType.StartTag || _type == HtmlTokenType.Character;
    ...
    /// </summary>
    public bool IsPublicIdentifierMissing => _structTokenDoctypeData?.PublicIdentifier == null;

    /// <summary>
    /// Gets the state of the system identifier.
    /// </summary>
    public bool IsSystemIdentifierMissing => _structTokenDoctypeData?.SystemIdentifier == null;
