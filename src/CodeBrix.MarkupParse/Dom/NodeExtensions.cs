...
public static class NodeExtensions
{
    ...
    /// <returns>An iterator over all descendants and itself.</returns>
    internal static IEnumerable<INode> GetDescendantsAndSelf<TState>(this INode parent, Stack<INode> stack, Func<INode, TState, bool> filter = null, TState state = default)
    {
        stack.Push(parent);
    ...
    /// </returns>
    public static bool HasDataListAncestor(this INode child) => child.Ancestors<IHtmlDataListElement>().Any();
    ...
    /// </returns>
    public static bool HasTextNodes(this INode node) => node.ChildNodes.OfType<IText>().Any();
    ...
    /// <returns>The instance or null.</returns>
    public static TNode FindDescendant<TNode>(this INode parent, int maxDepth = 1024)
        where TNode : class, INode
    {
