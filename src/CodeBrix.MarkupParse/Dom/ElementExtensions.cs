...
public static class ElementExtensions
{
    ...
    public static bool IsOpen(this IElement element)
    {
    ...
    /// </remarks>
    private static bool CheckActive(IElement element) => false;
    ...
    /// </remarks>
    private static bool CheckVisited(IElement element) => false;
    ...
    /// </remarks>
    public static bool IsVisible(this IElement element) => false;
    ...
    public static bool IsMutable(this IHtmlInputElement input) => !input.IsDisabled && !input.IsReadOnly;
    ...
    /// <returns>True if the element is mutable, otherwise false.</returns>
    public static bool IsMutable(this IHtmlTextAreaElement textArea) => !textArea.IsDisabled && !textArea.IsReadOnly;
    ...
    internal static bool HasOwnAttribute(this Element element, string name) => element.Attributes.GetNamedItem(null, name) != null;
    ...
    internal static void SetOwnAttribute(this Element element, string name, string value, bool suppressCallbacks = false) =>
