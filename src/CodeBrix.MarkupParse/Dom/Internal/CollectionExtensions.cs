...
public static class CollectionExtensions
{
    ...
    public static IEnumerable<T> GetNodes<T>(this INode parent, bool deep = true, Func<T, bool> predicate = null)
        where T : class, INode
    {
        predicate ??= (_ => true);
    ...
    private static IEnumerable<T> GetAllNodes<T>(this INode parent, Func<T, bool> predicate)
        where T : class, INode
