...
public static class SelectorExtensions
{
    ...
    public static T Eq<T>(this IEnumerable<T> elements, int index)
    ...
    public static IEnumerable<T> Gt<T>(this IEnumerable<T> elements, int index)
        where T : IElement
    {
        if (elements is null)
        {
    ...
    /// <returns>The remaining elements.</returns>
    public static IEnumerable<T> Lt<T>(this IEnumerable<T> elements, int index)
        where T : IElement
    {
        if (elements is null)
        {
    ...
    private static IEnumerable<T> Filter<T>(this IEnumerable<T> elements, ISelector selector, bool result)
        where T : IElement
    {
        selector ??= AllSelector.Instance;
    ...
    private static IEnumerable<T> Filter<T>(this IEnumerable<T> elements, string selectorText, bool result)
        where T : IElement
    {
        var selector = CreateSelector(elements, selectorText);
