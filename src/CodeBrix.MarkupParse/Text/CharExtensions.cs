...
public static class CharExtensions
{
    ...
    /// </returns>
    public static int FromHex(this char c) => c.IsDigit() ? c - 0x30 : c - (c.IsLowercaseAscii() ? 0x57 : 0x37);
    ...
    public static bool IsInRange(this char c, int lower, int upper) => c >= lower && c <= upper;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsUppercaseAscii(this char c) => c >= 0x41 && c <= 0x5a;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsLowercaseAscii(this char c) => c >= 0x61 && c <= 0x7a;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsHex(this char c) => c.IsDigit() || (c >= 0x41 && c <= 0x46) || (c >= 0x61 && c <= 0x66);
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNonAscii(this char c) => c != Symbols.EndOfFile && c >= 0x80;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNonPrintable(this char c) => (c >= 0x0 && c <= 0x8) || (c >= 0xe && c <= 0x1f) || (c >= 0x7f && c <= 0x9f);
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsLetter(this char c) => IsUppercaseAscii(c) || IsLowercaseAscii(c);
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsName(this char c) => c.IsNonAscii() || c.IsLetter() || c == Symbols.Underscore || c == Symbols.Minus || c.IsDigit();
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNameStart(this char c) => c.IsNonAscii() || c.IsUppercaseAscii() || c.IsLowercaseAscii() || c == Symbols.Underscore;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsLineBreak(this char c) => c == Symbols.LineFeed || c == Symbols.CarriageReturn;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsDigit(this char c) => c >= 0x30 && c <= 0x39;
    ...
    /// <returns>The result of the test.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsInvalid(this int c) => c == 0 || c > Symbols.MaximumCodepoint || (c > 0xD800 && c < 0xDFFF);
}
