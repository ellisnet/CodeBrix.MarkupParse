...
public sealed class TextSource : ITextSource
{
    ...
    public string ReadCharacters(int characters) => _readOnlyTextSource.ReadCharacters(characters);

    /// <inheritdoc/>
    public StringOrMemory ReadMemory(int characters) => _readOnlyTextSource.ReadMemory(characters);
    ...
    public Task PrefetchAsync(int length, CancellationToken cancellationToken) => _readOnlyTextSource.PrefetchAsync(length, cancellationToken);
    ...
    public bool TryGetContentLength(out int length) => _readOnlyTextSource.TryGetContentLength(out length);
