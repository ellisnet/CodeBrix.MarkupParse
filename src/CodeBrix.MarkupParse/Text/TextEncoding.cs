...
public static class TextEncoding
{
    ...
    public static bool IsUnicode(this Encoding encoding) => encoding == Utf16Be || encoding == Utf16Le;
    ...
    /// </returns>
    public static bool IsSupported(string charset) => encodings.ContainsKey(charset);
