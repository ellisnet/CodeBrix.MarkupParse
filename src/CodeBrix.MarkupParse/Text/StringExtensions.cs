...
public static class StringExtensions
{
        ...
        for (var i = 0; i < length; i++)
        {
            ...
            if (c.IsUppercaseAscii())
            {
                ...
                else
                {
                    ...
                    var result = rent.AsSpan(0, length);
    ...
    {
        if (!string.IsNullOrEmpty(value) && int.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out var converted))
        {
            return converted;
        }
    ...
    {
        if (!string.IsNullOrEmpty(value) && uint.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out var converted))
        {
            return converted;
        }
    ...
    {
        if (!string.IsNullOrEmpty(value) && bool.TryParse(value, out var converted))
        {
            return converted;
        }
