...
using CodeBrix.MarkupParse.Browser.Dom;
...
public sealed class BrowsingContext : EventTarget, IBrowsingContext, IDisposable
{
    ...
    public BrowsingContext(IConfiguration configuration = null)
        : this((configuration ?? CodeBrix.MarkupParse.Configuration.Default).Services, Sandboxes.None)
    {
    }
    ...
    {
        configuration ??= CodeBrix.MarkupParse.Configuration.Default;
